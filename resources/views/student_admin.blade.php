...
<head>
  ...
  <!-- prettier-ignore -->
    ...
    <linkrel="stylesheet"href="https://unpkg.com/animate.css@4.1.1/animate.css"/><linkrel="stylesheet"href="https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&display=swap"data-tag="font"/>
    ...
    <div>
      <div class="students-container">
        <div class="students-students">
          <img
            src="images/student_admin/rectangle1684828-kxhw-200h.png"
            alt="Rectangle1684828"
            class="students-rectangle168"
          />
          <img
            src="images/student_admin/rectangle1694828-wcq-200h.png"
            alt="Rectangle1694828"
            class="students-rectangle169"
          />
          <img
            src="images/student_admin/rectangle1714828-f3o-200h.png"
            alt="Rectangle1714828"
            class="students-rectangle171"
          />
          <img
            src="images/student_admin/rectangle1704828-hrfi-200h.png"
            alt="Rectangle1704828"
            class="students-rectangle170"
          />
          <img
            src="images/student_admin/rectangle1664828-o3m-200h.png"
            alt="Rectangle1664828"
            class="students-rectangle166"
          />
          <img
            src="images/student_admin/rectangle1674828-rzvb-200h.png"
            alt="Rectangle1674828"
            class="students-rectangle167"
          />
          <img
            src="images/student_admin/rectangle1554828-sar-1100h.png"
            alt="Rectangle1554828"
            class="students-rectangle155"
          />
          <div class="students-group18">
            <img
              src="images/student_admin/image54828-cre9-200h.png"
              alt="image54828"
              class="students-image5"
            />
            <img
              src="images/student_admin/spcnremovebgpreview144828-vl4-200h.png"
              alt="spcnremovebgpreview144828"
              class="students-spcnremovebgpreview14"
            />
            <span class="students-text"><span>Admin Dashboard</span></span>
            <img
              src="images/student_admin/image84828-q088-200h.png"
              alt="image84828"
              class="students-image8"
            />
            <img
              src="images/student_admin/rectangle1564828-0c5a.svg"
              alt="Rectangle1564828"
              class="students-rectangle156"
            />
            <img
              src="images/student_admin/rectangle1574828-jyzx.svg"
              alt="Rectangle1574828"
              class="students-rectangle157"
            />
            <img
              src="images/student_admin/rectangle1584828-vmok.svg"
            ...
            <img
              src="images/student_admin/image64828-052m-200h.png"
              alt="image64828"
              class="students-image6"
            />
