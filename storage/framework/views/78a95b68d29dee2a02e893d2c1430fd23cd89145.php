  ...
  <div class="admin-dashboard-container">
    <div class="admin-dashboard-admin-dashboard">
      ...
      <div class="admin-dashboard-group18">
        ...
        <button class="admin-dashboard-button" onclick="window.location.href = '<?php echo e(route('student')); ?>'">
          <a href="<?php echo e(route('student')); ?>" class="admin-dashboard-text02">STUDENTS</a>
        </button>
        <button class="admin-dashboard-button" onclick="window.location.href = '<?php echo e(route('instructor')); ?>'">
          <a href="<?php echo e(route('instructor')); ?>" class="admin-dashboard-text04">INSTRUCTOR</a>
        </button>
        <button class="admin-dashboard-button" onclick="window.location.href = '<?php echo e(route('attendance_log')); ?>'">
...
<?php /**PATH D:\xampp\htdocs\github\spc-qr-code-attendance\spc-qr-code-attendance\resources\views/admin.blade.php ENDPATH**/ ?>