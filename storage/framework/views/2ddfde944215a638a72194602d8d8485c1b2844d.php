      ...
      <div class="instructor-container">
        ...
        <div class="button-container">
              <button class="students-text02">
                <a href="<?php echo e(route('student')); ?>"  class="students-text02">STUDENTS</a>
              </button>
              <button class="instructor-text03">
                <a href="<?php echo e(route('instructor')); ?>" class="instructor-text03">INSTRUCTOR</a>
              </button>
              <button class="attendancelog-text04">
                <a href="<?php echo e(route('attendance_log')); ?>" class="attendancelog-text04">ATTENDANCE LOG</a>
              </button>
            </div>
...
<?php /**PATH D:\xampp\htdocs\github\spc-qr-code-attendance\spc-qr-code-attendance\resources\views/instructor_admin.blade.php ENDPATH**/ ?>