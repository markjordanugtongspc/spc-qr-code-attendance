      ...
      <div class="students-container">
        <div class="students-students">
          ...
          <div class="students-group18">
            ...
            <div class="button-container">
              ...
              <button class="students-text04">
                <a href="<?php echo e(route('instructor')); ?>" class="student-text04">INSTRUCTOR</a>
              </button>
              <button class="students-text06">
                <a href="<?php echo e(route('attendance_log')); ?>" class="instructor-text06">ATTENDANCE LOG</a>
              </button>
            </div>
          ...
          <img
            ...
            class="students-rectangle163"
          />
        </div>
      </div>
    </div>
  </body>
</html><?php /**PATH D:\xampp\htdocs\github\spc-qr-code-attendance\spc-qr-code-attendance\resources\views/student_admin.blade.php ENDPATH**/ ?>